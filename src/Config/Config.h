 ...
 *  name.
 *
 *  @see AbsConfig::desc_visible_
 *  @see AbsConfig::desc_hidden_
 *
 *  Usage example:
 *
 *  @code
 ...
 *
 *  Parsing command line and an optional config file (see AbsConfig::config_file_)
 *  is very simple through AbsConfig::InitializeOptions(const AbsConfig&) and 
 *  AbsConfig::InitializeOptions(int, char* []). 
 *
 *  Usage example:
 *
 *  @code
 ...
 *  // See AbsConfig::InitializeOptions() why you should avoid initializing via 
 *  // argc and argv again.
 ...
 *  AbsConfig::LoadOptions(). Again, see boost documentation on how to get the 
 *  parsed options.
 *
 *  Usage example:
 *
