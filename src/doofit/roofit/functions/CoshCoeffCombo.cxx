...
#include "CoshCoeffCombo.h" 
#include "RooAbsReal.h" 
#include "RooAbsCategory.h" 
#include <math.h> 
#include "TMath.h" 

ClassImp(doofit::roofit::functions::CoshCoeffCombo)

namespace doofit {
namespace roofit {
namespace functions {
  
CoshCoeffCombo::CoshCoeffCombo(std::string name,
...
CoshCoeffCombo::CoshCoeffCombo(const CoshCoeffCombo& other, const char* name) :
